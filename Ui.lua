...
MainFrame.Size = isMobile and UDim2.new(0, 380, 0, 600) or UDim2.new(0, 450, 0, 650)
MainFrame.Position = UDim2.new(0.5, -(isMobile and 190 or 225), 0.5, -(isMobile and 300 or 325))
...
local VoidTab = createTab("Void Control", 0)
local EvasionTab = createTab("Evasion", 120)
local AdvancedTab = createTab("Advanced", 240)
...
ContentFrame.ScrollBarThickness = isMobile and 4 or 6
...
function createToggle(parent, title, setting, order)
    ...
    toggleCircle.Position = UIConfig[setting] and UDim2.new(1, -26, 0.5, -10.5) or UDim2.new(0, 4, 0.5, -10.5)
    ...
    toggle.MouseButton1Click:Connect(function()
        ...
        TweenService:Create(toggleCircle, TweenInfo.new(0.2), {
            Position = UIConfig[setting] and UDim2.new(1, -26, 0.5, -10.5) or UDim2.new(0, 4, 0.5, -10.5)
        }):Play()
    end)
...
function createSlider(parent, title, setting, min, max, suffix, order)
    ...
    dragButton.Position = UDim2.new((UIConfig[setting] - min) / (max - min), -10, 0.5, -10)
...
function createDropdown(parent, title, setting, options, order)
    ...
    dropdown.Position = UDim2.new(1, -135, 0.5, -15)
...
local function updateTabColors()
    ...
    local tabNames = {"Void Control", "Evasion", "Advanced"}
